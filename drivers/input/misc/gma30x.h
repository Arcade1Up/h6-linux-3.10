...
#ifdef EWMA_FILTER
	#define EWMA_POSITIVE	10000	/* The values ?‹â€‹are all positive */
	#define EWMA_FACTOR		1024	/* Magnification 2^10=1024ï¼ŒAll values ?‹â€?< 10 */
	#define EWMA_WEIGHT_X	2		/* 2(Î±=0.5)ï¼?(Î±=0.25)ï¼?(Î±=0.125)ï¼?6(Î±=0.0625) */
	#define EWMA_WEIGHT_Y	2		/* 2(Î±=0.5)ï¼?(Î±=0.25)ï¼?(Î±=0.125)ï¼?6(Î±=0.0625) */
	#define EWMA_WEIGHT_Z	4		/* 2(Î±=0.5)ï¼?(Î±=0.25)ï¼?(Î±=0.125)ï¼?6(Î±=0.0625) */
#endif
