...
extern unsigned int suspend_hdmi_cec_phyaddr;
#endif
...
#else
#if (defined CONFIG_ARCH_SUN50IW6P1)
void arisc_set_hdmi_cec_phyaddr(unsigned int phyaddr)
{
	suspend_hdmi_cec_phyaddr = phyaddr;
}
EXPORT_SYMBOL_GPL(arisc_set_hdmi_cec_phyaddr);
#endif
