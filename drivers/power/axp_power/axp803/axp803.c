...
#endif
{
	...
	axp803_pmu_num = axp_get_pmu_num(axp803_dt_ids,
				ARRAY_SIZE(axp803_dt_ids));
	if (axp803_pmu_num < 0) {
	...
	ret = axp_mfd_cell_name_init(&axp803_platform_ops,
				ARRAY_SIZE(axp803_dt_ids), axp803->pmu_num,
	...
	axp803->regmap = axp_regmap_init_arisc_twi(device);
#else
