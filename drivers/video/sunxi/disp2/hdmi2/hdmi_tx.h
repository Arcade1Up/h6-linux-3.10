...
struct reg_addr_value {
	unsigned int addr;
	unsigned int val;
};

struct hdmi_clk_config {
	unsigned int pixel_clk;

	struct reg_addr_value parent_clk;
	struct reg_addr_value parent_pctl;/*pattern control*/
	struct reg_addr_value parent_bias;
	struct reg_addr_value tcon_clk;
	struct reg_addr_value hdmi_clk;
	struct reg_addr_value hdmi_clk_reset;
};
