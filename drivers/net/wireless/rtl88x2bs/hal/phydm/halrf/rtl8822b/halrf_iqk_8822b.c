...
)
{
	...
	odm_set_bb_reg(p_dm_odm, 0x9a4, BIT(31), 0x0);
}
...
/*IQK_version:0x2d NCTL:0x8*/
/*1.update IQK: 0x2b*/
/*2. fix HWTX stop issue*/
void
...
)
{
	...
	if (*(p_dm_odm->p_mp_mode))
		halrf_iqk_hwtx_check(p_dm_odm, true);
	...
	if (*(p_dm_odm->p_mp_mode))
		halrf_iqk_hwtx_check(p_dm_odm, false);
