...
u32	glcoex_ver_date_8822b_1ant = 20180413;
		...
		*btcoexist)
{
	...
	if ((bt_link_info->a2dp_exist) && (coex_sta->is_bt_a2dp_sink)) {
		halbtc8822b1ant_coex_table_with_type(btcoexist, NORMAL_EXEC, 26);
		halbtc8822b1ant_ps_tdma(btcoexist, NORMAL_EXEC, TRUE, 58);
