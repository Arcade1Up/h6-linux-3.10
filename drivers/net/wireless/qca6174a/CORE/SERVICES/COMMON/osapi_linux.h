...
struct sunxi_pcie_page {
	unsigned long offset;
	void __iomem *mem_base;
};
extern unsigned int sunxi_ioread32(void __iomem *addr, unsigned long offset);
extern void sunxi_iowrite32(void __iomem *addr, unsigned long offset, u32 value);

#define A_PCI_READ32(addr, offset)		sunxi_ioread32((void __iomem *)(addr), (unsigned long)(offset))
#define A_PCI_WRITE32(addr, offset, value)	sunxi_iowrite32((void __iomem *)(addr), (unsigned long)(offset), (u32)(value))
