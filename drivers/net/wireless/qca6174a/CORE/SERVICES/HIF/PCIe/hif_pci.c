...
WAR_PCI_WRITE32(char *addr, u32 offset, u32 value)
{
	if (hif_pci_war1) {
	    ...
	    page = sunxi_pcie_device_cutpage_config(0x05600000, offset);
#if 0
...
#endif
        (void)ioread32((void __iomem *)(page.mem_base + page.offset+4)); /* 3rd read prior to write */
        (void)ioread32((void __iomem *)(page.mem_base + page.offset+4)); /* 2nd read prior to write */
        (void)ioread32((void __iomem *)(page.mem_base + page.offset+4)); /* 1st read prior to write */
        iowrite32((u32)(value), (void __iomem *)(page.mem_base + page.offset));
...
HIFTargetReadChecked(A_target_id_t targid, A_UINT32 offset)
{
    ...
    value = A_PCI_READ32(ARGID_TO_PCI_ADDR(targid), offset);
