...
static inline u8* atbm_ieee80211_find_p2p_ie(u8* ie_start,size_t ie_len)
{
...
static inline u8* atbm_ieee80211_find_p2p_attr(u8* attr_start,size_t attr_len,u8 attr_id)
{
...
static inline int ieee80211_p2p_action_check(u8* data,size_t data_len)
{
	#define RETURN_ERR do{res = -1;goto action_check_end;}while(0)
	int res = 0;
	u8* p2p_data = data;
	size_t p2p_data_len = data_len;
	u32 oui_wfa = 0;
