...
static int inline proc_set_priority(struct xradio_common *hw_priv, u8 idx)
{
	struct sched_param param = {
		.sched_priority = g_dpa[idx].priority
	};
...
u32 proc_up_cnt;
u32 proc_down_cnt;
static int inline proc_dpa_update(struct xradio_common *hw_priv)
{
	int tx_ret = 0;
	int rx_ret = 0;
	int dpa_old = 0;
...
static int inline xradio_device_sleep(struct xradio_common *hw_priv)
{
	int ret;
