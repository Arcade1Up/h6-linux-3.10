...
#define XR829_BOOTLOADER    ("/system/etc/firmware/boot_xr829.bin")
#define XR829_FIRMWARE      ("/system/etc/firmware/fw_xr829.bin")
#define XR829_SDD_FILE      ("/system/etc/firmware/sdd_xr829.bin")
#else
